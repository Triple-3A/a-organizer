    ...
    <app-layout title="Dashboard">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="mt-12 flex items-center justify-center">
                        <h1 class="text-azul text-lg font-bold ">Asignación técnico</h1>
                </div> 
        </div>
        ...
        <div className="mt-4 flex justify-center">
           <div class="mb-3 w-250">
                <Label forInput="role" value="Role" />
                    ...
                    id="role"
                    class="px-3
                    py-1.5 bg-amarillo text-base mt-1 
                    rounded select w-96"
                    >
                        <option class ="bg-ambar-200 text-white text-xs" value="">Técnicos</option>
                        <option 
                        class ="font-weight-bold text-xs bg-amarillo bg-opacity-50" 
                        :value="item.id" 
        ...
        <div className="mt-4 flex justify-center">
           <div class="mb-3 w-250">
                <Label forInput="role" value="Role" />
                    ...
                    rounded select w-96"
                    >
                        <option class ="bg-ambar-200 text-white text-xs" value="">Usuarios</option>
                        <option 
                        class ="font-weight-bold text-xs bg-amarillo bg-opacity-50" 
                        :value="item.id" 
